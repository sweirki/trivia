...
export default function ResultsScreen() {
  ...
  const rewardScale = useSharedValue(0.96);
  ...
  useEffect(() => {
    ...
    rewardOpacity.value = withDelay(120, withTiming(1, { duration: 220 }));
    rewardScale.value = withDelay(120, withSpring(1, { damping: 13, stiffness: 150 }));

    const totalReward = earnedXP + earnedCoins + earnedGems + earnedTickets;
    if (totalReward > 0) {
      feedback.reward();
    } else if (score > 0) {
      feedback.win();
  ...
  }, [earnedCoins, earnedGems, earnedTickets, earnedXP, rewardOpacity, rewardScale, score, scoreScale]);
      ...
      <SafeAreaView style={styles.safe}>
        ...
        >
          ...
          <View style={styles.resultCard}>
            ...
            <Animated.View style={[styles.rewardGrid, rewardStyle]}>
              {earnedXP > 0 ? (
