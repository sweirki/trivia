...
const [prevTickets, setPrevTickets] = useState<number | null>(null);
...
useEffect(() => {
  ...
  const delta = tickets - prevTickets;
  if (delta > 0) {
    setEarnedTickets(delta);
  }
  ...
  useEffect(() => {
    ...
    playRewardFeedback({
      ...
      coins: earnedCoins,
      gems: earnedGems,
      tickets: typeof earnedTickets === "number" ? earnedTickets : 0,
      levelUp: justLeveledUp,
    });
  }, [visible, earnedXP, earnedCoins, earnedGems, earnedTickets, justLeveledUp]);
