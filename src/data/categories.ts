...
const CATEGORY_SHELLS: CategoryShell[] = [
  ...
  { id: "sports", label: "Sports", premium: false, price: 0, icon: historyIcon, color: "#FF5722" },
  { id: "popculture", label: "Pop Culture", premium: false, price: 0, icon: literatureIcon, color: "#673AB7" },
  { id: "logic",  label: "Logic", premium: false, price: 0,
  icon: logicIcon,  color: "#009688" },
  { id: "technology", label: "Technology", premium: false, price: 0, icon: logicIcon, color: "#00ACC1" },
  ...
  { id: "business", label: "Business", premium: true, price: 3.99, icon: foodIcon, color: "#5C6BC0" },
